    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-start justify-center z-30 p-3 sm:p-4 pt-24 md:pt-28">
      <div className="relative w-full max-w-md sm:max-w-xl bg-white rounded-2xl md:rounded-3xl shadow-xl mt-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-4 mb-3 md:mb-5">
          ...
          <button
            type="button"
            onClick={() => setIsSelectingDocType(true)}
            className="flex flex-col items-center justify-center py-3 px-3 md:p-4 rounded-2xl border-2 border-purple-200  hover:bg-purple-100 transition-colors"
          >
            <div className="mb-1.5">
              <svg
        ...
        <div className="mb-3 md:mb-5">
          ...
          {isSelectingDocType && !uploadedFileName && (
            <div className="mb-2.5 p-3 md:p-4 bg-gray-50 rounded-lg border border-gray-200">
              ...
              <label className="block text-[11px] md:text-sm font-medium text-gray-700 mb-2">
                Type of document *
              </label>
              <select
                value={supportingDocumentType}
                onChange={(e) => setSupportingDocumentType(e.target.value)}
                className="w-full rounded-lg border border-gray-300 bg-white px-3 py-2.5 text-sm text-gray-700 focus:outline-none focus:ring-2 focus:ring-purple-500 mb-3"
              >
              ...
              <button
                ...
                disabled={!supportingDocumentType}
                className="w-full py-2.5 px-3 bg-purple-700 text-white rounded-lg text-xs md:text-sm font-medium hover:bg-purple-800 transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
              >
                Choose File
              </button>
            </div>
